...
output.dir.hdfs <- paste('/user/',Sys.getenv('USER'),'/out/RHIPE_30GB_2012-pages-articles',sep='')
output.file.local <- 'output_30GB_2012pages-articles.txt'
...
rhipe.results <- rhwatch(
                        ...
                        jobname='Wordcount_30GB_Articles')
