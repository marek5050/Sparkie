...
#input.file.hdfs <- paste('/user/',Sys.getenv('USER'),'/data/b.txt',sep='')
...
output.dir.hdfs <- paste('/user/',Sys.getenv('USER'),'/out/RHIPE_30GB_3_2012-pages-articles',sep='')
output.file.local <- 'output_30GB_3_2012pages-articles.txt'
...
rhipe.results <- rhwatch(
                        ...
                        jobname='Wordcount20Reducers30GB',
